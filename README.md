...
HarshGPT is an open-source **agentic AI chatbot** built with **Python, FastAPI, LangGraph, LangChain, Google Gemini, Tavily, ChromaDB, and SQLite**.
...
```bash
git clone https://github.com/harsh-veer/HarshGPT
```
...
```bash
conda create -n HarshGPT python=3.11 -y
```

### 4. Activate the virtual environment

```bash
conda activate HarshGPT
```
